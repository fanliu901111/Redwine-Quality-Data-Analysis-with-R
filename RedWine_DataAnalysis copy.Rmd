...
The boxplot shows a bunch of outliers of residual.sugar.
...
g1.clean <- plot.hist_clean('residual.sugar', rw, 0.05) + xlab('residual.sugar')
g2.clean <- plot.hist_clean('free.sulfur.dioxide', rw, 0.07) + xlab('free.sulfur.dioxide')
g3.clean <- plot.hist_clean('total.sulfur.dioxide', rw, 0.1) + xlab('total.sulfur.dioxide')
g4.clean <- plot.hist_clean('sulphates', rw, 0.02) + xlab('sulphates')
...
```{r}
g_alcohol_n <-
ggplot(aes(x=rw$quality,y=rw$alcohol),data=rw)+
    geom_point(color='#FF00CC',alpha=1/4)+
...
```{r}
g_alcohol_m <- 
ggplot(aes(x=rw$quality,y=rw$volatile.acidity),data=rw)+
    geom_point(color='#FF00CC',alpha=1/4)+
    xlab("Wine Quality") + ylab("Volatitle.acidity") +
...
```{r}
g_alcohol_s <-
ggplot(aes(x=rw$quality,y=rw$sulphates),data=rw)+
    geom_point(color='#FF00CC',alpha=1/4)+
...
ggplot(aes(x=rw$citric.acid,y=rw$volatile.acidity),data=rw)+
    geom_point(color='#FF00CC',alpha=1/4)+
    xlab("citric.acid") + ylab("volatile.acidity") +
...
```{r}
ggplot(rw, aes(x=rw$quality,y=rw$volatile.acidity,
                      color = rw$sulphates))+
        geom_point(alpha=1/4)+
        scale_colour_gradient2()+
        facet_wrap(~rating)
...
ggplot(aes(x = quality), data = rw)+
  geom_histogram(colour="black", fill="#FF00CC",binwidth = 1)+
